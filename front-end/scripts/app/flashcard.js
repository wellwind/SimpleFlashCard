...
/***/ function(module, exports, __webpack_require__) {
	...
	var FlashCard = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var QuestionNumber = __webpack_require__(169);
	var MainContainer = __webpack_require__(170);
	var Score = __webpack_require__(171);
	...
	var FlashCard = React.createClass({
	    ...
	    markAnswerCorrect: function markAnswerCorrect(correct) {
	        var copyQuestoins = JSON.parse(JSON.stringify(this.state.questions));
	        var currentQuestion = copyQuestoins[this.state.currentQuestionIndex];
	        currentQuestion.correct = correct;
	        this.setState({ questions: copyQuestoins });
	    },
	    goPrevQuestion: function goPrevQuestion() {
	        if (this.state.currentQuestionIndex > 0) {
	            this.setState({ currentQuestionIndex: this.state.currentQuestionIndex - 1 });
	        }
	    },
	    goNextQuestion: function goNextQuestion() {
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(QuestionNumber, { currentQuestionNumber: this.state.currentQuestionIndex + 1, totalQuestions: this.state.questions.length })
	                    )
	                ),
	                React.createElement(
	                    "div",
	                    ...
	                    React.createElement(Score, { questions: this.state.questions })
	                )
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainContainer = React.createClass({
	    ...
	    markCorrect: function markCorrect() {
	        this.props.markAnswerCorrect(true);
	    },
	    markWrong: function markWrong() {
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "div",
	                    { className: "fc-chinese " + (currentQuestion.show ? "" : "fc-blur") },
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "text-success " + (currentQuestion.correct === true ? "show" : "hide") },
	                        React.createElement("i", { className: "fa fa-fw fa-check-circle" })
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: "text-danger " + (currentQuestion.correct === false ? "show" : "hide") },
	                        React.createElement("i", { className: "fa fa-fw fa-times-circle" })
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: currentQuestion.correct === null ? "show" : "hide" },
	                        " "
	                    )
	                )
	            ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Score = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            "div",
	            { className: "text-center " + (questionResult.totalQuestions === this.props.questions.length ? "show" : "hide") },
	            React.createElement(
	                "h3",
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "span",
	                    { className: score >= 60 ? "text-success" : "text-danger" },
	                    React.createElement(
	                        "u",
	                        null,
	                        score
